...
import 'package:ungrci/screens/detail.dart';
    ...
    return Column(mainAxisAlignment: MainAxisAlignment.end,
      children: <Widget>[
        Row(
          mainAxisAlignment: MainAxisAlignment.end,
          children: <Widget>[
            Container(margin: EdgeInsets.only(bottom: 20.0, right: 20.0),
    ...
    try {
      ...
      for (var productModel in productModels) {
        if (qrCode == productModel.qrCode) {
          ...
          MaterialPageRoute materialPageRoute = MaterialPageRoute(builder: (BuildContext context)=>Detail(productModel: productModel,));
